                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <th class="text-center" style="background-color: #000 ;width: 20px;font-size: 8pt;">No</th>

                                <th class="text-center" style="background-color: #000 !important;width: 50px;font-size: 11pt;">Nomor PO</th>

                                <th class="text-center" style="background-color: #000 !important;width: 50px;font-size: 11pt;">Tanggal</th>

                                <th class="text-center" style="background-color: #000 !important;width: 50px;font-size: 11pt;">Total</th>
                        ...
                        <tbody>
                            ...
                            <?php if ($omset): ?>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" class="text-center" style="font-size: 8pt;">TOTAL</td>
                            ...
                            <?php else: ?>
                                ...
                                <tr>
                                    ...
                                    <td class="bg-light" colspan="4">Tidak ada data.</td>
