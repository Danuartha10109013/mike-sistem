                    ...
                    <div class="kopatas">
                        <div class="" style="width: 100% !important;">
                            <div class="w-80" style="background-color: #d00c6c !important;">
                                ...
                                <h3 class="card-title text-start fw-bold ">Laporan Stok Keluar</h3>
                            </div>
                    ...
                    <table class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" style="background-color: #000 !important;width: 50px;font-size: 11pt;">Tanggal Keluar</th>
                            ...
                            <?php if ($stokKeluar): ?>
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $i['nama_barang']; ?></td>
                                        <td><?= $i['kode_barang']; ?></td>
                                        <td><?= date('d-m-Y', strtotime($i['tanggal_detail_gs'])); ?></td>
