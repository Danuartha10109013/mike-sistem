            ...
            <form action="<?= base_url('tambah-barang/'); ?>" method="post">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="kode_barang" class="form-control" value="<?= set_value('kode_barang'); ?>" required="">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="satuan_barang" class="form-control" value="<?= set_value('satuan_barang'); ?>" required="">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="harga_barang" class="form-control" value="<?= set_value('harga_barang'); ?>" required="">
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="poin_barang" class="form-control" value="<?= set_value('poin_barang'); ?>" required="">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="jenis_barang" >
                    ...
                    <option value="Fabrikasi" <?= set_value('jenis_barang') == 'Fabrikasi' ? 'selected' : '' ; ?> >Fabrikasi</option>

                    <option value="Cleaning Supply" <?= set_value('jenis_barang') == 'Cleaning Supply' ? 'selected' : '' ; ?> >Cleaning Supply</option>

                    <option value="General Supply" <?= set_value('jenis_barang') == 'General Supply' ? 'selected' : '' ; ?> >General Supply</option>
