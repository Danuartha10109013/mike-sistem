        ...
        <tbody class="body-surat">
            <tr>
                <td class="body-surat-cell">
                    ...
                    <h5 class=" mb-4 text-left">Nama Barang : <?= $b['nama_barang'] ?></h5>

                    <h5 class=" mb-4 text-left">Stok Terbaru : <?= $stok['stok'] ?></h5>
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <th class="text-center" style="background-color: #000 !important;width: 150px;font-size: 11pt;">Customer</th>
                                <th class="text-center" style="background-color: #000 !important;width: 150px;font-size: 11pt;">Driver</th>
                            </tr>
                            ...
                            <?php if ($barang): ?>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center" style="font-size: 11pt;"><?= $i['nama_user'] ?></td>
                                        <td class="text-center" style="font-size: 11pt;"><?= $i['driver'] ?></td>
                                    </tr>
