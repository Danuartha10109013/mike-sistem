          ...
          <div class="card">
            <div class="card-header">
              ...
              <div class="card-header-action">
                <a href="<?= base_url('tambah-stok-opname'); ?>" class="btn btn-info"><i class="fa fa-plus"></i> Tambah Data</a>
              </div>
                    ...
                    ?>
                      <tr>
                        ...
                        <td class="text-center">
                          <a href="<?= base_url('edit-stok-opname/' . $u['id_stok_opname']); ?>" class="btn btn-info"><i class="fa fa-edit"></i> Edit</a>
                          <button class="btn btn-danger" data-confirm="Anda yakin ingin menghapus data ini?|Data yang sudah dihapus tidak akan kembali." data-confirm-yes="document.location.href='<?= base_url('hapus-stok-opname/' . $u['id_stok_opname']); ?>';"><i class="fa fa-trash"></i> Delete</button>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
