      ...
      <nav class="navbar navbar-secondary navbar-expand-lg">
        <div class="container">
          <ul class="navbar-nav">
                ...
                <?php if (in_array("Admin", $this->session->userdata('role'))): ?>
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="nav-item"><a href="<?= base_url('inden-keluar'); ?>" class="nav-link">Indent Barang</a></li>
                    </ul>
                  </li>
            ...
            <!-- main menu yg sebelumnya -->
            <li class="nav-item dropdown d-none d-sm-none d-lg-block d-xl-block
             <?= $title == 'Data Riwayat' || $title == 'Data Barang' ? 'active' : ''; ?>">
              <a href="#" data-toggle="dropdown" class="nav-link has-dropdown"><i class="far bi bi-inbox"></i><span>Main Menu</span></a>
              <ul class="dropdown-menu">
                <?php if (in_array("Admin", $this->session->userdata('role'))): ?>
                  <li class="nav-item dropdown">
                    <a href="#" class="nav-link has-dropdown">Barang</a>
                    <ul class="dropdown-menu">
                      <li class="nav-item"><a href="<?= base_url('barang'); ?>" class="nav-link">Master Barang</a></li>
                      <li class="nav-item"><a href="<?= base_url('barang-masuk'); ?>" class="nav-link">Barang Masuk</a></li>
                      <li class="nav-item"><a href="<?= base_url('stok-barang') ?>" class="nav-link">Stok Barang</a></li>
                      <li class="nav-item"><a href="<?= base_url('stok-opname') ?>" class="nav-link">Stok Opname</a></li>
                      <li class="nav-item"><a href="<?= base_url('tracking-barang'); ?>" class="nav-link">Tracking Barang</a></li>
                    </ul>
                  </li>
                  <li class="nav-item"><a href="<?= base_url('data-order'); ?>" class="nav-link">Data Order</a></li>
                  <li class="nav-item "><a href="<?= base_url('package'); ?>" class="nav-link">Data Paket</a></li>
                <?php endif; ?>
                <?php if (in_array("Finance", $this->session->userdata('role'))): ?>
                  <li class="nav-item"><a href="<?= base_url('pembelian'); ?>" class="nav-link">Pembelian</a></li>
                  <li class="nav-item"><a href="<?= base_url('invoice'); ?>" class="nav-link">Invoice</a></li>
                  <li class="nav-item dropdown"><a href="#" class="nav-link has-dropdown">Riwayat</a>
                    <ul class="dropdown-menu">
                      <li class="nav-item"><a href="<?= base_url('riwayat-pesanan'); ?>" class="nav-link">Riwayat Pesanan</a></li>
                      <li class="nav-item"><a href="<?= base_url('riwayat-invoice'); ?>" class="nav-link">Riwayat Tagihan</a></li>
                      <!-- <li class="nav-item"><a href="<?= base_url('status-tagihan'); ?>" class="nav-link">Status Tagihan</a></li> -->
                    </ul>
                  </li>
                <?php endif; ?>
                <li class="nav-item dropdown"><a href="#" class="nav-link has-dropdown">Laporan</a>
                  <ul class="dropdown-menu">
                    <?php if (in_array("Admin", $this->session->userdata('role'))): ?>
                      <li class="nav-item"><a href="<?= base_url('laporan-pemasukan-stok') ?>" class="nav-link">Pemasukan Stok</a></li>
                      <li class="nav-item"><a href="<?= base_url('laporan-pengeluaran-stok') ?>" class="nav-link">Pengeluaran Stok</a></li>
                    <?php endif; ?>
                    <?php if (in_array("Finance", $this->session->userdata('role'))): ?>
                      <li class="nav-item"><a href="<?= base_url('laporan-pendapatan-finance') ?>" class="nav-link">Pendapatan Finance</a></li>
                      <!-- <li class="nav-item"><a href="#" class="nav-link">Sisa Tagihan</a></li>
                    <li class="nav-item"><a href="#" class="nav-link">Masa Tagihan</a></li> -->
                    <?php endif; ?>
            ...
            <!-- mobile -->
            <?php if (in_array("Admin", $this->session->userdata('role'))): ?>
              <li class="nav-item  d-block d-sm-block d-lg-none d-xl-none dropdown bg-light"> <b class="ml-3 "> Inventory</b></li>
              <li class="nav-item  d-block d-sm-block d-lg-none d-xl-none dropdown">
                <a href="#" data-toggle="dropdown" class="nav-link has-dropdown"><i class="far bi bi-box"></i><span>Barang</span></a>
                <ul class="dropdown-menu">
                  <li class="nav-item"><a href="<?= base_url('barang'); ?>" class="nav-link">Master Barang</a></li>
                  <li class="nav-item"><a href="<?= base_url('barang-masuk'); ?>" class="nav-link">Barang Masuk</a></li>
                  <li class="nav-item"><a href="<?= base_url('stok-barang') ?>" class="nav-link">Stok Barang</a></li>
              ...
              <li class="nav-item d-block d-sm-block d-lg-none d-xl-none"><a href="<?= base_url('tracking-barang'); ?>" class="nav-link"><i class="far bi-search"></i><span>Tracking Barang</span></a></li>

              <li class="nav-item d-block d-sm-block d-lg-none d-xl-none"><a href="<?= base_url('package'); ?>" class="nav-link"><i class="far bi-card-checklist"></i><span>Data Paket</span></a></li>
              <!-- //mobile sales -->
              <li class="nav-item  d-block d-sm-block d-lg-none d-xl-none dropdown bg-light"> <b class="ml-3 "> Sales</b></li>

              <li class="nav-item d-block d-sm-block d-lg-none d-xl-none"><a href="<?= base_url('data-order'); ?>" class="nav-link"><i class="far bi bi-cart-check-fill"></i><span>Order</span></a></li>
            <?php endif; ?>
            <?php if (in_array("Finance", $this->session->userdata('role'))): ?>
              <li class="nav-item d-block d-sm-block d-lg-none d-xl-none"><a href="<?= base_url('invoice'); ?>" class="nav-link"><i class="far bi bi-newspaper"></i><span>Invoice</span></a></li>
              <li class="nav-item d-block d-sm-block d-lg-none d-xl-none"><a href="<?= base_url('return'); ?>" class="nav-link"><i class="far bi bi-arrow-counterclockwise"></i><span>Return</span></a></li>
              <!-- //mobile finance -->
              <li class="nav-item  d-block d-sm-block d-lg-none d-xl-none dropdown bg-light"> <b class="ml-3 "> Finance</b></li>

              <li class="nav-item d-block d-sm-block d-lg-none d-xl-none"><a href="<?= base_url('pembelian'); ?>" class="nav-link"><i class="far bi bi-cart-check-fill"></i><span>Pembelian</span></a></li>
              <li class="nav-item d-block d-sm-block d-lg-none d-xl-none"><a href="<?= base_url('penjualan'); ?>" class="nav-link"><i class="far bi bi-cart-check-fill"></i><span>Penjualan</span></a></li>

              <li class="nav-item d-block d-sm-block d-lg-none d-xl-none dropdown"><a href="#" data-toggle="dropdown" class="nav-link has-dropdown"><i class="far bi bi-clock-history"></i><span>Riwayat</span></a>
                <ul class="dropdown-menu">
                  <li class="nav-item"><a href="<?= base_url('riwayat-pesanan'); ?>" class="nav-link">Riwayat Pesanan</a></li>
                  <li class="nav-item"><a href="<?= base_url('riwayat-invoice'); ?>" class="nav-link">Riwayat Tagihan</a></li>
                  <!-- <li class="nav-item"><a href="<?= base_url('status-tagihan'); ?>" class="nav-link">Status Tagihan</a></li> -->
            ...
            <?php endif; ?>
            <li class="nav-item d-block d-sm-block d-lg-none d-xl-none dropdown"><a href="#" data-toggle="dropdown" class="nav-link has-dropdown"><i class="far bi bi-clipboard-data-fill"></i><span>Laporan</span></a>
              <ul class="dropdown-menu">
