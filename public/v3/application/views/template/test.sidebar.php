      ...
      <div class="container mb-5 mb-md-0">
        <ul class="navbar-nav">
          ...
          <?php if (in_array("Admin", $this->session->userdata('role'))): ?>
            ...
            <li class="nav-item d-block d-sm-block d-lg-none d-xl-none "><a href="<?= base_url('barang'); ?>" class="nav-link"><i class="far bi bi-box"></i>Master Barang</a></li>
            <li class="nav-item d-block d-sm-block d-lg-none d-xl-none "><a href="<?= base_url('barang-masuk'); ?>" class="nav-link"><i class="far bi bi-box"></i>Barang Masuk</a></li>
