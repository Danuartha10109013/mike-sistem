        ...
        <div class="mt-2">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="card-title mb-4 text-center"><?= 'Laporan Invoice Fabrikasi' ?></h3>
                            ...
                            <table class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="font-size: 8pt;width: 100px;">No. Invoice</th>
                                        <th style="font-size: 8pt;width: 80px;">Tanggal</th>
                                        <th style="font-size: 8pt;width: 300px;">Nama Barang</th>
