  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">By User</div>
      </div>
    </div>
    ...
    <div class="section-body">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <form action="<?= base_url('laporan-omset-fabrikasi-by-user'); ?>" method="post">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control barang" name="id_user" id="select-bidang" data-live-search="true" required>
                    <option disabled selected>-- Pilih User --</option>
                    <?php foreach ($user as $item):?>
                    <option value="<?= $item['id_user']?>" <?= set_value('id_user') == $item['id_user'] ? 'selected' : '' ; ?> ><?= $item['nama']; ?></option>
                    <?php endforeach;?>
                  </select>
