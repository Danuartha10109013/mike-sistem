  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        <div class="breadcrumb-item active"><a href="#">Laporan Invoice General Supply</a></div>
        <div class="breadcrumb-item">Laporan Invoice General Supply</div>
      </div>
    </div>
    ...
    <div class="section-body">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <form action="<?= base_url('laporan-gs'); ?>" method="post">
