  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">Tambah Detail BC General Supply</div>
      </div>
    </div>
    ...
    <div class="section-body">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <form action="<?= base_url('tambah-detail-bc-gs/'.$id_bc_gs); ?>" method="post">
              <div class="card-header">
                <h4>Form Tambah Detail BC General Supply</h4>
              </div>
              <div class="card-body">
                <div class="form-group">
                  ...
                  <select class="form-control" name="id_gs" id="select-pegawai" data-live-search="true">
                    ...
                    <option value="<?= $b['id_gs']?>" <?= set_value('id_gs') == $b['id_gs'] ? 'selected' : '' ; ?> ><?= $b['no_invoice']; ?></option>
                    <?php endforeach;?>
                  </select>
