  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">Edit Project Non PO</div>
      </div>
    </div>
    ...
    <div class="section-body">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <form action="<?= base_url('edit-pbo/'.$p['id_pbo']); ?>" method="post">
              <div class="card-header">
                <h4>Form Edit Project Non PO</h4>
              </div>
              <div class="card-body">
                <div class="form-group">
                  ...
                  <select class="form-control barang-pbo" name="id_barang" id="barang-pbo" data-live-search="true">
                    ...
                    <option value="0" <?= set_value('id_barang', '0') == '0' ? 'selected' : '' ; ?> >NEW ITEM</option>
                    <?php foreach ($barang as $b):?>
                    <option value="<?= $b['id_barang']?>" <?= set_value('id_barang', $p['id_barang']) == $b['id_barang'] ? 'selected' : '' ; ?> ><?= $b['kode_barang'].' - '.$b['nama_barang']; ?></option>
                    <?php endforeach;?>
                  </select>
                ...
                <div class="form-group">
                  <label>PO</label>
                  <input type="text" name="po" class="form-control" value="<?= set_value('po', $p['po']); ?>" required="">
                ...
                <div class="form-group">
                  <label>Status</label>
                  <input type="text" name="status" class="form-control" value="<?= set_value('status', $p['status']); ?>" required="">
