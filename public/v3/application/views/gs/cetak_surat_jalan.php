        ...
        <div class="mt-2">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <img src="<?= base_url(); ?>assets/img/header_surat_jalan-min.png" width="100%">
                            <table class="" border="0" width="100%">
                                <tbody>
                                    <tr>
                                        <td class="text-center" width="70%"></td>
                                        <td class="" style="font-size: 8pt;"><?= $f['no_invoice'] ?><br/><?= $tanggal ?><br/>Kepada :<br/>PT. TKG TAEKWANG INDONESIA<br/>Dusun Belendung II RT. 17 RW.06<br/>Desa Belendung<br/>Kec. Cibogo, Kab. Subang</td>
                                    </tr>
                                </tbody>
                            </table>
                            <br/>
                            ...
                            <table class="" border="1" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" style="font-size: 8pt;">NAMA BARANG</th>
                                        <th class="text-center" style="width: 80px;font-size: 8pt;">ITEM CODE</th>
                                        <th class="text-center" style="width: 30px;font-size: 8pt;">QTY</th>
                                        <th class="text-center" style="width: 40px;font-size: 8pt;">UOM</th>
                                        <th class="text-center" style="width: 60px;font-size: 8pt;">PO</th>
                                        <th class="text-center" style="width: 80px;font-size: 8pt;">DEPARTMENT</th>
                                        <th class="text-center" style="width: 80px;font-size: 8pt;">USER</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php if($f_detail): ?>
                            ...
                            <table class="table table-striped table-bordered">
                                <tbody>
                                    <tr>
                                        <td class="text-center" width="60%">HORMAT KAMI<br/><br/><br/><br/><br/><br/><br/>EKA IMAM MAULANA</td>
