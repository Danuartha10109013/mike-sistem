...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'uzisteven18@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Admin Helpdesk - CIFO'; // Isikan dengan nama pengirim
    protected $password = 'capricorn031999'; // Isikan dengan password email pengirim
